...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (document.querySelector('.s_contacts__map')) {
    function init() {
      ...
      var marker = new google.maps.Marker({
        ...
        map: map,
        title: 'Soda!',
        icon: 'https://alexander-fadieiev.github.io/soda-site/images/map.png'
      });
    }
    // init();
  }
  ...
  if (document.querySelector('#bubbles-canvas')) {
    ...
    if ($('#bubbles-canvas').data('page') == 'blue') {
      var items = [{
        name: 'item1',
        path: 'https://alexander-fadieiev.github.io/soda-site/images/blue2.png'
      }];
    } else if ($('#bubbles-canvas').data('page') == 'pink') {
      var items = [{
        name: 'item1',
        path: 'https://alexander-fadieiev.github.io/soda-site/images/pink2.png'
      }];
    } else {
      var items = [{
        name: 'item1',
    ...
    // explosion image
    loader.add('item3', 'https://alexander-fadieiev.github.io/soda-site/images/explosion-blue.png');
    loader.add('item4', 'https://alexander-fadieiev.github.io/soda-site/images/explosion-pink.png');
    //bottle
    loader.add('bottle', 'https://alexander-fadieiev.github.io/soda-site/images/bottle.png');
    loader.add('cork', 'https://alexander-fadieiev.github.io/soda-site/images/cork.png');
      ...
      function generateBubble(type) {
        ...
        if (document.querySelector('.js-communications') && document.querySelector('.js-performance')) {
          if ($('.js-communications').offset().top <= window.innerHeight / 2 + window.scrollY) {
            //sprite pink
            item = new PIXI.Sprite.fromImage('https://alexander-fadieiev.github.io/soda-site/images/pink2.png');
          } else {
            //sprite blue
            item = new PIXI.Sprite.fromImage('https://alexander-fadieiev.github.io/soda-site/images/blue2.png');
          }
        ...
        item.killBubble = function (death, type) {
          ...
          if (death) {
            ...
            var explosion;
            item.alpha = 1;
            if (imgUrl == 'https://alexander-fadieiev.github.io/soda-site/images/blue2.png') {
              explosion = PIXI.Texture.fromImage('https://alexander-fadieiev.github.io/soda-site/images/explosion-blue.png');
              ...
              explosion = PIXI.Texture.fromImage('https://alexander-fadieiev.github.io/soda-site/images/explosion-pink.png');
              var style = new PIXI.TextStyle({
                fontFamily: 'GothamPro',
                fontSize: 32,
                fontWeight: 'bold',
          ...
          if ($('.js-communications').offset().top <= window.innerHeight / 2 + window.scrollY && dir) {
            ...
            array.forEach(function (item, i) {
              ...
              tl.to(item.scale, 0.7, { x: 0, y: 0, onComplete: function () {
                  item.texture = PIXI.Texture.fromImage('https://alexander-fadieiev.github.io/soda-site/images/pink2.png');
                } });
            ...
            array.forEach(function (item, i) {
              ...
              var tl = new TimelineMax();
              tl.to(item.scale, 0.7, { x: 0, y: 0, onComplete: function () {
                  item.texture = PIXI.Texture.fromImage('https://alexander-fadieiev.github.io/soda-site/images/blue2.png');
                } });
              tl.to(item.scale, 0.7, { x: currentScale, y: currentScale });
            });
          }
